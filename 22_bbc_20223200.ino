...
#define _DUTY_NEU 1350  // Servo angle: 0 degree,  ㄱ
#define _DUTY_MIN 700   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 150 // Replace with |D - E| degree, 바꾸기 ㄱ
#define _SERVO_SPEED 100 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 550
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (68.4 + -0.235*a_value + 2.01*0.0001*a_value*a_value)*10;
